...
public class Quick {
    ...
    private static void sort(Comparable[] a, Comparator comparator,int lo, int hi) { 
        if (hi <= lo) return;
    ...
    private static int partition(Comparable[] a, Comparator comparator, int lo, int hi) {
        int i = lo;
        int j = hi + 1;
        Comparable v = a[lo];
        while (true) { 
    ...
    ***************************************************************************/
    ...
    private static boolean isSorted(Comparable[] a, Comparator comparator, int lo, int hi) {
        for (int i = lo + 1; i <= hi; i++)
